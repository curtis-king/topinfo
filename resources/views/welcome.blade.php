        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                ...
                <article class="group relative bg-white rounded-2xl border border-gray-100 p-8 hover:border-brand-blue/30 hover:shadow-xl hover:shadow-brand-blue/5 transition-all duration-300 overflow-hidden">
                    ...
                    <div class="w-14 h-14 rounded-xl bg-brand-blue flex items-center justify-center mb-6 shadow-lg shadow-brand-blue/25 group-hover:scale-105 transition-transform p-2">
                        @php $iconUrl = is_object($service) ? $service->icon_url : null; @endphp
                        @if ($iconUrl)
                            <img src="{{ $iconUrl }}" alt="{{ $serviceName }}" class="w-full h-full object-contain brightness-0 invert">
                        @else
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-12">
                <div class="sm:col-span-2 lg:col-span-1">
                    ...
                    <p class="text-sm leading-relaxed text-gray-400">
                        <span class="text-brand-blue font-semibold">TOP</span><span class="text-white font-semibold">INFO</span> — Solutions informatiques complètes pour entreprise au Congo-Brazzaville.
                    </p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm">
                        ...
                        <li class="flex items-start gap-2">
                            ...
                            Brazzaville: 57, Avenue des 3 Martyrs, Ouenze <br> Pointe-Noire: Mpita, Derrière BRALICO
                        </li>
                    </ul>
                </div>
            </div>
